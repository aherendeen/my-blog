...
const config: SiteConfig = {
  ...
  site: 'https://aherendeen.com',
  // The name of your site, used in the title and for SEO.
  title: "Andrew Herendeen's Blog",
  // The description of your site, used for SEO and RSS feed.
  description: "Andrew Herendeen's Personal Blog",
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Andrew Herendeen',
  // Keywords for SEO, used in the meta tags.
  tags: ['Saint George', 'Business', 'Accounting', 'Tax', 'Development'],
  // Path to the image used for generating social media previews.
  // Needs to be a square JPEG file due to limitations of the social card generator.
  // Try https://squoosh.app/ to easily convert images to JPEG.
  // The path should be relative to the project root (e.g., './src/content/avatar.jpg').
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/aherendeen',
      external: true,
    },
  ],
  ...
  giscus: {
    repo: 'aherendeen/my-blog',
    repoId: 'R_kgDOPiFyYA',
    category: 'Giscus',
    categoryId: 'DIC_kwDOPiFyYM4Cuc8l',
    reactionsEnabled: true, // Enable reactions on post itself
  },
  // These are characters available for the character chat feature.
  // The keys must match the character names used in the chat feature for correct mapping.
